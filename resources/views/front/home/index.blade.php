...
@push('meta-seo')
    <meta name="description" value="Blog Rafif Gaming, seputar pemograman dan teknologi mantap">
    <meta name="keyword" value="rafif gaming, rafifhibatullah, rafifganz">
    <meta property="og:title" content="Laravel Blog - rafif"/>
    <meta property="og:url" value="{{ url()->current() }}"> 
    <meta property="og:site_name" content="Blog Rafif"/>
    <meta property="og:description" value="Blog Rafif Gaming, seputar pemograman dan teknologi mantap"> 
    <meta property="og:image" value="{{ asset('storage/back/'.$latest_post->img) }}"> 
@endpush
@section('title', 'Laravel Blog - rafif')
